...
{
    MALGTK_MALITEM_PRIORITY_INVALID = -1,
    MALGTK_MALITEM_PRIORITY_LOW     = 0,
    MALGTK_MALITEM_PRIORITY_MEDIUM  = 1,
    MALGTK_MALITEM_PRIORITY_HIGH    = 2
} MalgtkMalitemPriority;

typedef enum /*< prefix=MALGTK_MALITEM >*/
{
    MALGTK_MALITEM_RECONSUME_VALUE_INVALID   = -1,
    MALGTK_MALITEM_RECONSUME_VALUE_VERY_LOW  = 1,
    MALGTK_MALITEM_RECONSUME_VALUE_LOW       = 2,
    MALGTK_MALITEM_RECONSUME_VALUE_MEDIUM    = 3,
    MALGTK_MALITEM_RECONSUME_VALUE_HIGH      = 4,
    MALGTK_MALITEM_RECONSUME_VALUE_VERY_HIGH = 5
